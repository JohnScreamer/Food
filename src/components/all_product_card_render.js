...
const PRODUCT_CONTEINER = document.querySelector('.product');
   ...
   async render() {
      ...
      data.forEach(el => {
         ...
         if (amount) {
            ...
            htmlVariable += `<li class="card" data-id='${el.id}' data-food-type='${el.type}' >
      ...
      ul = `<ul class="product__list">${htmlVariable}</ul>`


      MAIN__TITLE.innerHTML = title
      PRODUCT_CONTEINER.innerHTML = ul;
...
const allProduct = new CardRender()
